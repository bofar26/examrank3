...
/*   Updated: 2025/11/06 00:37:41 by mipang           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void selection_sort(char *a, int n) { int i, j, m; char t; for (i = 0; i + 1 < n; i++) { m = i; for (j = i + 1; j < n; j++) if (a[j] < a[m]) m = j; if (m != i) { t = a[i]; a[i] = a[m]; a[m] = t; } } }
